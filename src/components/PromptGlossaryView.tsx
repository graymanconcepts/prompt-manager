...
const PromptGlossaryView: React.FC = () => {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-4">Prompt Glossary</h1>
        <div className="flex gap-4">
          <div className="relative w-96">
            <input
              type="text"
              placeholder="Search through prompts by title, content, or tags..."
              className="w-full px-4 py-2 pl-10 pr-8 rounded-md border border-gray-300 bg-gray-50 text-gray-900 shadow-sm focus:border-blue-500 focus:outline-none sm:text-sm"
              value={searchTerm}
          ...
          <select
            className="px-4 py-2 rounded-md border border-gray-300 bg-gray-50 text-gray-900 shadow-sm focus:border-blue-500 focus:outline-none sm:text-sm"
            ...
            <div key={index} className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                {category.subcategories.map((sub, subIndex) => (
                  <div key={subIndex} className="bg-gray-50 rounded-md p-4">
                    <h3 className="font-medium text-lg mb-2">{sub.option}</h3>
